...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_5_genes_7_interactions_25_time_series/Ecoli_5_genes_7_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_5_genes_7_interactions_50_time_series/Ecoli_5_genes_7_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_10_genes_14_interactions_25_time_series/Ecoli_10_genes_14_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_10_genes_14_interactions_50_time_series/Ecoli_10_genes_14_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_10_genes_20_interactions_25_time_series/Ecoli_10_genes_20_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_10_genes_20_interactions_50_time_series/Ecoli_10_genes_20_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_20_genes_24_interactions_25_time_series/Ecoli_20_genes_24_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_20_genes_24_interactions_50_time_series/Ecoli_20_genes_24_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_20_genes_35_interactions_25_time_series/Ecoli_20_genes_35_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)
...
dt = repmat(dt, No_Time_Points-1,1);
[Adjacency_Matrix]=BGRMI(mRNA1, dt, No_Time_Points, No_Replicates);
file_name = 'data/bgrmi/predicted/ecoli_20_genes_35_interactions_50_time_series/Ecoli_20_genes_35_interactions_dream4_adjacency.tsv';
dlmwrite(file_name,Adjacency_Matrix,'delimiter','\t','precision',10)